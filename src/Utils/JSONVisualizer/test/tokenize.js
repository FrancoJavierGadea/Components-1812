...
const TARGETS = [
    {
        ...
        json: {number: 1812}, 
        expected: [
            {type: 'brace', value: '{', tags: ['brace', 'brace-open'] },
            ...
            {type: 'brace', value: '}', tags: ['brace', 'brace-close'] },
        ] 
    },
    {
        name: 'basic string', 
    ...
    },
    {
        ...
        json: [], 
        expected: [
            {type: 'bracket', value: '[', tags: ['bracket', 'bracket-open'] },
            {type: 'bracket', value: ']', tags: ['bracket', 'bracket-close'] },
        ]
    },
    {
